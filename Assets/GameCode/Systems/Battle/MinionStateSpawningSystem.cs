...
namespace Legacy.Client
{
    ...
    public class MinionStateSpawningSystem : ComponentSystem, IStateSystemInterface
    {
        ...
        protected override void OnCreate()
        {
            _query_minions = GetEntityQuery(
                ...
                ComponentType.ReadOnly<StateSpawning>());
        }
        protected override void OnUpdate()
        {
            ...
            {
                _animators[i].ResetBools("Landing");
                _animators[i].SetBool("Landing", true);
            }
        }
